...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    if (!blog) {
        return {
            title: 'Blog Not Found | Kunal M Shende',
        }
    }

    const title = `${blog.title} | Kunal M Shende's Blog`
    const description = blog.shortDescription || `Read ${blog.title} by Kunal M Shende.`
